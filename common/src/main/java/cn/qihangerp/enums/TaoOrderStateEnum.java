...
public enum TaoOrderStateEnum {
    ...
    TRADE_BUYER_SIGNED("买家已签收,货到付款专用", "TRADE_BUYER_SIGNED",3),
    PAID_FORBID_CONSIGN("拼团中订单或者发货强管控的订单，已付款但禁止发货", "PAID_FORBID_CONSIGN",22),
    TRADE_CLOSED("交易关闭", "TRADE_CLOSED",13),
    TRADE_CLOSED_BY_TAOBAO ("交易关闭", "TRADE_CLOSED_BY_TAOBAO",13);
    private String name;
    private String code;
    private int index;
