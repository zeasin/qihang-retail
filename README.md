...
> **开源、轻量、可扩展的线下零售业务管理平台。帮助中小零售商实现商品、采购、库存、销售、会员全链路数字化管理。告别 Excel 手工记账，让零售生意更高效。**
...
启航零售ERP 是一个面向线下零售企业的开源业务管理平台。它将零售企业最核心的**商品管理、采购管理、库存管理、销售管理、售后管理、会员管理**等环节整合到一个统一平台，帮助零售商实现从进货到销售的全链路数字化。
...
| 跨境云仓WMS | 跨境仓储管理 | [Gitee](https://gitee.com/qiliping/qihang-overseas-wms) | [GitHub](https://github.com/zeasin/qihang-overseas-wms) |
