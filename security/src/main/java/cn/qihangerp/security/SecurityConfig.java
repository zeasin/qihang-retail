...
//                .logout().disable()
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.GET, "/sys-api/captchaImage").permitAll()
                        .requestMatchers(HttpMethod.GET, "/sys-api/system/config/**").permitAll()
                        .requestMatchers("/pdd/oauth_callback").permitAll()
                        // 允许直接访问授权登录接口
                        .requestMatchers(HttpMethod.POST, "/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/sys-api/login").permitAll()
                        // SSE 推送通知放行
                        .requestMatchers("/erp-api/sse/notify_msg").permitAll()
                        // AI简报接口放行
                        .requestMatchers(HttpMethod.GET, "/ai/brief").permitAll()
